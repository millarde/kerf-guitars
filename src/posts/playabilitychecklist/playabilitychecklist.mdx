...
kind: blog
slug: playabilitychecklist
image: ./images/string-action-gauge.png
date: 2021-07-14
author: Millard

---

Playability is our prime directive. We're not trying to build you "the best" guitar (whatever that might mean) or the prettiest guitar (you win, PRS). Whatever it is, we want it to play the best it possibly can. But what does that mean? Why don't guitars come that way?
...
![fret hammer on fret](/images/hammering-frets.png "seat the frets")
...
![file laying on fretboard](/images/shaping-frets.png "preparing to shape frets")
...
![notched straight edge on fretboard](/images/fretboard-straightedge.png "checking fingerboard relief")
...
![feeler gauge under B string](/images/feeler-gauge-action.png "a precise setup matters")
...
![radius gauge checking string height](/images/setting-radius-bridge.png "setting string height at bridge")
...
Want a guitar setup this carefully? Visit the Guitars page.

[Subscribe](http://eepurl.com/hyCJqP) to get notified of updates.